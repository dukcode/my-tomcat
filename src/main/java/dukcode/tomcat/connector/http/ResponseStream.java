...
public class ResponseStream extends ServletOutputStream {
    ...
    /**
     * The content length past which we will not write, or -1 if there is no defined content
     * length.
     */
    ...
    /**
     * Close this output stream, causing any buffered data to be flushed and any further output data
    ...
    /**
     * Flush any buffered data for this output stream, which also causes the response to be
     * committed.
     */
