...
public class HttpRequest implements HttpServletRequest {
    ...
    /**
     * The HTTP headers associated with this Request, keyed by name.  The values are ArrayLists of
     ...
     * particular request are parsed and stored here, they are not modified. Therefore, application
     * level access to the parameters need not be synchronized.
     */
    ...
    /**
     * Parse the parameters of this request, if it has not already occurred. If parameters are
     * present in both the query string and the request content, they are merged.
     */
    ...
    /**
     * Set a flag indicating whether or not the requested session ID for this request came in
     * through a cookie.  This is normally called by the HTTP Connector, when it parses the request
     * headers.
     *
    ...
    // Method of HttpServletRequest New Version
