...
public class RequestStream
    ...
    /**
     * Read some number of bytes from the input stream, and store them into the buffer array b.  The
     * number of bytes actually read is returned as an integer.  This method blocks until input data
    ...
    /**
     * Read up to <code>len</code> bytes of data from the input stream into an array of bytes.  An
     * attempt is made to read as many as
