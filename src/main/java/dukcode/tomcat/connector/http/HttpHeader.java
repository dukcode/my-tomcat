...
final class HttpHeader {
    ...
    /**
     * Release all object references, and initialize instance variables, in preparation for reuse of
     * this object.
     */
    public void recycle() {
    ...
    /**
     * Test if the name of the header is equal to the given char array. All the characters must
    ...
    /**
     * Test if the name of the header is equal to the given string. The String given must be made of
    ...
    /**
     * Test if the name of the header is equal to the given header. All the characters in the name
    ...
    /**
     * Test if the name and value of the header is equal to the given header. All the characters in
     * the name must already be lower case.
     */
    ...
    /**
     * Return hash code. The hash code of the HttpHeader object is the same as returned by new
     * String(name, 0, nameEnd).hashCode().
     */
    public int hashCode() {
        int h = hashCode;
        if (h == 0) {
